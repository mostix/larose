<?php
  ...
  if(isset($_POST['insert_invoice_not_bg'])) {
    ...
    if(isset($success)) {
?>
      <form name="add_invoice_address" method="post" class="form form-horizontal" action="/<?=$_GET['page'];?>">
        <div class="success_field"><?=$languages[$current_lang]['text_add_address_success'];?></div>
        <p>&nbsp;</p>
...
?>
      <form name="add_invoice_address" method="post" id="bg_form" class="form form-horizontal" <?=$bg_form_style;?> action="/<?=$_GET['page'];?>">
        ...
        <div>
          <button type="submit" name="insert_invoice_bg" class="btn btn-success button outline-outward">
      ...
      <form name="add_invoice_address" method="post" id="not_bg_form" class="form form-horizontal" action="/<?=$_GET['page'];?>" <?=$not_bg_form_style;?>>
        ...
        <div>
          <a href="/<?=$current_lang;?>/user-profiles/user-profile-invoice-addresses" class="btn btn-primary btn-danger button outline-outward">
            <?=$languages[$current_lang]['btn_cancel'];?>
          </a>
