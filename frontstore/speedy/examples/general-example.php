...
$clientConfiguration->userName = '999816';                 // Конфигурирайте името на потребителя преодставен за вас от Speedy
$clientConfiguration->userPassword = '1367878673';             // Конфигурирайте паролата за потребителя преодставен за вас от Speedy
...
*/
    ...
    if (count($arrFinalServices) == 1) {
        ...
        //echo $Arr['ResultCalculation_takingDate'];
        ...
        echo "Резултат:<br>";
        echo "---------<br>";
        print_r($arrResultCalculationMS);
