...
?>
      <form name="edit_invoice_address" method="post" id="bg_form" class="form" <?=$bg_form_style;?> action="/<?=$_GET['page']."?iaid=".$invoice_id;?>">
        <fieldset>
          <legend><?=$languages[$current_lang]['header_edit_invoice_address'];?></legend>
          ...
          <div>
            ...
            <button type="submit" name="update_invoice_bg" class="btn btn-primary button outline-outward">
      ...
      <form name="edit_invoice_address" method="post" id="not_bg_form" class="form" <?=$not_bg_form_style;?> action="/<?=$_GET['page']."?iaid=".$invoice_id;?>">
        <fieldset>
          <legend><?=$languages[$current_lang]['header_edit_invoice_address'];?></legend>
          <div<?php if(!empty($errors['invoice_firstname'])) echo ' class="error_field"';?>>
            <label for="invoice_firstname"><?=$languages[$current_lang]['header_invoice_firstname'];?><span class="red">*</span></label>
          ...
          <div>
            ...
            <button type="submit" name="update_invoice_not_bg" class="btn btn-primary button outline-outward">
              <?=$languages[$current_lang]['btn_save'];?>
            </button>
          </div>
