<?php
  ...
  if(isset($_POST['insert_invoice_bg'])) {
    ...
    foreach($_POST as $name => $value) {
      ...
      if(empty($trimed_value) && ($name != "insert_invoice_bg" && $name != "invoice_site_name_label" && $name != "invoice_site_id" && $name != "invoice_is_default")) {
    ...
    $invoice_country_id = $_POST['invoice_country_id'];
    ...
    if(empty($errors) && !empty($customer_id)) {
      ...
      $query_insert_invoice_addr = "INSERT INTO `invoice_addresses`(
                                                    `invoice_id`, 
                                                    `customer_id`, 
                                                    `invoice_country_id`, 
                                                    `invoice_firstname`, 
                                            ...
                                            VALUES ('',
                                                    ...
                                                    '$invoice_site_id',
                                                    '$invoice_street',
                                                    $invoice_site_postcode,
                                                    '$invoice_site_name',
                                                    '$invoice_is_default')";
      //echo $query_insert_invoice_addr;exit;
      $all_queries .= "<br>\n".$query_insert_invoice_addr ;
      $result_insert_invoice_addr  = mysqli_query($db_link, $query_insert_invoice_addr );
...
<?php
  ...
  if(isset($_POST['insert_invoice_not_bg'])) {
    //echo "<pre>";print_r($_POST);exit;
    ...
    foreach($_POST as $name => $value) {
      $trimed_value = trim($value);
      if(empty($trimed_value) && ($name != "insert_invoice_not_bg" && $name != "invoice_is_default")) {
...
?>
  <div class="row ">
    ...
    <div id="invoice_area" class="col-lg-10">
...
<?php
      ...
      //if(isset($_POST['invoice_country_id'])) echo $_POST['invoice_country_id']."<br>";
      if(isset($_POST['invoice_country_id'])) {
        if($_POST['invoice_country_id'] == 33) {
          $bg_form_style = "";
        }
        else {
          $not_bg_form_style = "";
...
?>
      <form name="add_invoice_address" method="post" id="bg_form" class="form" <?=$bg_form_style;?> action="/<?=$_GET['page'];?>">
        <fieldset>
          <legend><?=$languages[$current_lang]['header_add_invoice_address'];?></legend>
                ...
                if(mysqli_num_rows($result_countries) > 0) {
                  ...
                  while ($country = mysqli_fetch_assoc($result_countries)) {
                    ...
                    if(isset($_POST['invoice_country_id'])) {
                      ...
                      $selected = ($country_id == 33) ? 'selected="selected"' : "";
                    }
          ...
          <div class="float_left<?php if(!empty($errors['invoice_city'])) echo ' error_field';?>">
            ...
            <input type="text" name="invoice_site_type" class="disabled" id="invoice_site_type" value="<?php if(isset($invoice_site_type)) echo $invoice_site_type;else echo $languages[$current_lang]['header_site_type'];?>" disabled="disabled" style="width: 30px;" />
          ...
          <div class="float_left">
            ...
            <input type="hidden" name="invoice_site_id" id="invoice_site_id" value="" />
            <input type="hidden" name="invoice_site_name" id="invoice_site_name" value="" />
          ...
          <div>
            ...
            <button type="submit" name="insert_invoice_bg" class="btn btn-primary button outline-outward">
      ...
      <form name="add_invoice_address" method="post" id="not_bg_form" class="form" action="/<?=$_GET['page'];?>" <?=$not_bg_form_style;?>>
        <fieldset>
          <legend><?=$languages[$current_lang]['header_add_invoice_address'];?></legend>
          <div<?php if(!empty($errors['invoice_firstname'])) echo ' class="error_field"';?>>
            <label for="invoice_firstname"><?=$languages[$current_lang]['header_invoice_firstname'];?><span class="red">*</span></label>
          ...
          <div>
            ...
            <button type="submit" name="insert_invoice_not_bg" class="btn btn-primary button outline-outward">
              <?=$languages[$current_lang]['btn_save'];?>
            </button>
          </div>
